...
#get faker to generate names titles into a hash?
#use module?
#wouldn't it be DRYer to have all books in a hash? #but its not functional for library methods
# need to use subclasses
